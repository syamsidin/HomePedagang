 ...
 */
public class AdapterObrolan extends RecyclerView.Adapter<AdapterObrolan.ViewHolder> {
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        private final ImageView icon,chat;
        ...
        public ViewHolder(View v) {
            ...
            chat = (ImageView)v.findViewById(R.id.img_chat);
     ...
     */
    public AdapterObrolan(String[] dataSet, String[] dataSet2, int[] dataSet3) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup viewGroup, int viewType) {
        ...
        View v = LayoutInflater.from(viewGroup.getContext())
                .inflate(R.layout.list_pelanggan, viewGroup, false);
