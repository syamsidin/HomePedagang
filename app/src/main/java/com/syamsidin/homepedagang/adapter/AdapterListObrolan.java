 ...
 */
public class AdapterListObrolan extends RecyclerView.Adapter<AdapterListObrolan.ViewHolder> {
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View v) {
            ...
            textView3 = (TextView)v.findViewById(R.id.deskripsi2);
     ...
     */
    public AdapterListObrolan(String[] dataSet, String[] dataSet2, int[] dataSet3, String[] dataSet4) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup viewGroup, int viewType) {
        ...
        View v = LayoutInflater.from(viewGroup.getContext())
                .inflate(R.layout.list_list_obrolan, viewGroup, false);
