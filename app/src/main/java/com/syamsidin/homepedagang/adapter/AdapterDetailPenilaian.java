 ...
 */
public class AdapterDetailPenilaian extends RecyclerView.Adapter<AdapterDetailPenilaian.ViewHolder> {
     ...
     */
    public AdapterDetailPenilaian(String[] dataSet, String[] dataSet2, int[] dataSet3) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup viewGroup, int viewType) {
        ...
        View v = LayoutInflater.from(viewGroup.getContext())
                .inflate(R.layout.list_detail_penilaian, viewGroup, false);
